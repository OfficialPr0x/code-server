...
class AgentInteractions {
  ...
  setupEventListeners() {
    ...
    document.querySelector(".ai-chat-header .bx-minus").addEventListener("click", () => {
      ...
      this.chatDialog.querySelector(".ai-chat-messages").style.display =
        this.chatDialog.style.height === "48px" ? "none" : "block"
      this.chatDialog.querySelector(".ai-chat-input").style.display =
        this.chatDialog.style.height === "48px" ? "none" : "block"
    })
