...
exports.aiWarroomRouter = exports.handleArgsSocketCatchError = exports.ensureAddress = exports.createApp = exports.listen = void 0;
...
exports.aiWarroomRouter = (0, express_1.Router)();
exports.aiWarroomRouter.get('/ai-warroom', (req, res, next) => {
    // For demo purposes, allow access without authentication
    next();
}, async (req, res) => {
    res.sendFile(path_1.default.join(ROOT, 'src/browser/pages/ai-warroom.html'));
});
// Add static assets route for AI components
exports.aiWarroomRouter.use('/ai-warroom/static', (req, res, next) => {
    // For demo purposes, allow access without authentication
    next();
}, express_1.default.static(path_1.default.join(ROOT, 'src/browser/ai')));
